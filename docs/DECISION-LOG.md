...
**Status:** Superseded 2026-09-15 by D-2026-09-15-01.

**Source:** Chief Architect decision.

---

## 2026-09-15 ? Source available; production use requires a paid license (D-2026-09-15-01)
**Decision:** SuperDemocracy is no longer AGPL (or MIT). The GitHub repository stays public so people can inspect the code, fork, and contribute. The [LICENSE](LICENSE) allows reading, contributing, and local evaluation only. Hosting for real members or real votes, or selling access, requires a commercial license from Dustin Murray. Contributors grant Dustin Murray the right to use and commercially license their patches. AGPL dual-license (D-2026-09-14-01) is superseded.

**Why:** The Chief Architect wants contributors and inspectable voting code, not a free giveaway of the product. AGPL still allowed unpaid production hosting.

**Status:** Accepted. Plain-language license, not lawyer-drafted.
