...
**Explicit departure (Constitution Article X §2):** the North Star and Governance Principles describe Education Before Vote as "not an optional organization setting." This decision makes it optional **for community orgs only**. The Chief Architect should amend those sentences to say so; until then this entry is the record.

**Status:** Accepted. Community-org gate not yet implemented — see [plan/todo.md](plan/todo.md).
